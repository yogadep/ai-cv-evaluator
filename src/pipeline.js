...
// Strip code fences and extract a JSON object from an LLM reply
function parseJsonLoose(text) {
  ...
  // Very loose: keep substring between first { and last }
...
// Ask the model for JSON, then parse with parseJsonLoose
...
export const worker = new Worker(
  ...
  async (job) => {
    ...
    // Attach detailed components for the PDF
